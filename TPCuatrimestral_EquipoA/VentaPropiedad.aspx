            ...
            <div class="col-md-6 d-flex align-items-center justify-content-center">
                <div class="w-100 text-center">
                    ...
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="rfvNombre" runat="server" ControlToValidate="Nombre" ValidationGroup="Group1"
                    ...
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="rfvApellido" runat="server" ControlToValidate="Apellido" ValidationGroup="Group1"
                    ...
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="rfvTelefono" runat="server" ControlToValidate="Telefono" ValidationGroup="Group1"
                    ...
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="rfvEmail" runat="server" ControlToValidate="Email" ValidationGroup="Group1"
                    ...
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="rfvLocalidad" runat="server" ControlToValidate="Localidad" ValidationGroup="Group1"
                    ...
                    <asp:Button Text="Enviar" CssClass="btn btn-outline-success btn-largo" ValidationGroup="Group1"
                        runat="server" />
                </div>
            </div>
